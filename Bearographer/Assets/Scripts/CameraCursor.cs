...
public class CameraCursor : MonoBehaviour
{
    ...
    public List<GameObject> _bearsInRange = new List<GameObject>();
    ...
    void Start()
    {
       ...
       //Collider an Texturgröße anpassen
        ...
        Vector2 screenPositionOR = new Vector2(Input.mousePosition.x + _cursorTexWidth / 2, Input.mousePosition.y + _cursorTexHeight / 2);
        Vector2 screenPositionUL = new Vector2(Input.mousePosition.x - _cursorTexWidth / 2, Input.mousePosition.y - _cursorTexHeight / 2);
        ...
        Vector2 S = new Vector2( worldPositionOR.x - worldPositionUL.x, worldPositionOR.y - worldPositionUL.y);
        _collider.size = S;        
